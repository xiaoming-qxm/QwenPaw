# -*- coding: utf-8 -*-
"""Chrome action handler protocol."""
...
class ActionMeta:
    """Execution requirements for a Chrome action handler."""
...
class ActionHandler(Protocol):
    """Protocol implemented by typed Chrome action handlers."""
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        """Execute an action against Chrome state."""
