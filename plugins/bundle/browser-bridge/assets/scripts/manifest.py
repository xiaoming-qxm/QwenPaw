# -*- coding: utf-8 -*-
"""Manifest registry for browser-bridge backend instances."""
...
class ManifestEntry:
    """One QwenPaw backend endpoint advertised to browser-bridge."""
...
def deregister_instance(
    ...
    """Remove an entry from the browser-bridge manifest."""
    manifest = load_manifest(path)
