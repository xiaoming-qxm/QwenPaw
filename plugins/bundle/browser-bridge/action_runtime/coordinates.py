# -*- coding: utf-8 -*-
"""Coordinate helpers for Browser Bridge viewport actions."""
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "instruction": (
            ...
            "are not allowed immediately after screenshot observations; "
            "take a fresh snapshot and prefer ref/text/selector targets for "
            "state-changing actions. Do not repeat the same coordinate after "
            "an observed no-op."
        ),
    }
...
def _control_validate_viewport_coordinates(
    *,
    ...
    raise TargetResolutionFailed(
        ...
        "coordinates 0..{width:g} x 0..{height:g}. Browser Bridge "
