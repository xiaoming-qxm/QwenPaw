# -*- coding: utf-8 -*-
"""Local Browser Control product truth audit."""
...
MODEL_VISIBLE_PATHS = (
    ...
    "plugins/bundle/browser-control/skills/browser-control/SKILL.md",
    "plugins/bundle/browser-control/skills/browser-control/ops.md",
    "plugins/bundle/browser-control/skills/browser-control/blocker-report.md",
    "plugins/bundle/browser-control/skills/browser-control/control-mode.md",
)
VERIFIER_PATH = "scripts/verify/browser_control_verify.py"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Audit Browser Control product truth from local files.",
    )
...
def build_audit(repo_root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    return {
        "schema_version": "browser-control-v8-a.truth-audit.v1",
        ...
        findings.append(
            {
                ...
                "matched": "",
                "message": (
                    "No Browser Control hot-path legacy instructions found."
                ),
            },
        )
    return findings
            ...
            findings.append(
                {
                    ...
                    "message": (
                        "Legacy or site-specific Browser Control wording "
